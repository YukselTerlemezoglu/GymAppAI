        ...
        >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                <h3 style={{ margin: 0, color: '#fff', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <Utensils size={18} color="#ff6b81" /> Günlük Beslenme
                </h3>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', margin: '4px 0', fontSize: '0.85rem' }}>
                        <span style={{ color: 'var(--text-light)' }}>Kalori</span>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', borderLeft: '1px solid rgba(255,255,255,0.1)', paddingLeft: '15px' }}>
                    <div style={{ fontSize: '0.75rem', color: '#ff4757', fontWeight: 'bold' }}>Protein: {Math.round(totals.protein)}g</div>
                    <div style={{ fontSize: '0.75rem', color: '#00c3ff', fontWeight: 'bold' }}>Karb: {Math.round(totals.carbs)}g</div>
                    <div style={{ fontSize: '0.75rem', color: '#2ed573', fontWeight: 'bold' }}>Yağ: {Math.round(totals.fat)}g</div>
                </div>
            </div>
        </div>
    );
